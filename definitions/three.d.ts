...
declare namespace THREE {
   ...
   // custom blending src factors
    ...
    export class CylinderGeometry extends Geometry {
        /**
         * @param radiusTop â€” Radius of the cylinder at the top.
         * @param radiusBottom â€” Radius of the cylinder at the bottom.
         * @param height â€” Height of the cylinder.
         * @param radiusSegments â€” Number of segmented faces around the circumference of the cylinder.
         * @param heightSegments â€” Number of rows of faces along the height of the cylinder.
